...
% whose values are read out of the filed artifact 'truncation_evidence'
%   by scripts/iter11_paper_numbers.py.
% Re-render with: python scripts/iter11_paper_tables.py --write
\begin{table}[t]
\centering
\caption{Generation truncation, measured per arm against the completion gate that accepted the panel}\label{tab:truncation}
\resizebox{\textwidth}{!}{%
...
{\footnotesize\textit{Note.}
  12 cells truncated across 4 arms, of which 11 are classified repetition loops under the registered
